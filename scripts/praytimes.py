...
class PrayTimes():
	...
	def __init__(self, method = "Makkah") :
		...
		# initialize settings
		self.calcMethod = method if method in self.methods else 'Makkah'
...
prayTimes = PrayTimes(method="Makkah")
...
if __name__ == "__main__":
	...
	print('Prayer Times for today in Saarbruecken/Germany\n')
	times = prayTimes.getTimes(date.today(), (49.2402, 6.9969), +2);
	for i in ['Fajr', 'Dhuhr', 'Asr', 'Maghrib', 'Isha']:
		print(i+ ': '+times[i.lower()], end='')